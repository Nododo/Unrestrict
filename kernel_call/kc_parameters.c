...
addresses__iphone11_2__16A366() {
    ADDRESS(paciza_pointer__l2tp_domain_module_start)       = get_offset("paciza_pointer__l2tp_domain_module_start");
    ADDRESS(paciza_pointer__l2tp_domain_module_stop)        = get_offset("paciza_pointer__l2tp_domain_module_stop");
    ADDRESS(l2tp_domain_inited)                             = get_offset("l2tp_domain_inited");
    ADDRESS(sysctl__net_ppp_l2tp)                           = get_offset("sysctl__net_ppp_l2tp");
    ADDRESS(sysctl_unregister_oid)                          = get_offset("sysctl_unregister_oid");
    ADDRESS(mov_x0_x4__br_x5)                               = get_offset("mov_x0_x4__br_x5");
    ADDRESS(mov_x9_x0__br_x1)                               = get_offset("mov_x9_x0__br_x1");
    ADDRESS(mov_x10_x3__br_x6)                              = get_offset("mov_x10_x3__br_x6");
    ADDRESS(kernel_forge_pacia_gadget)                      = get_offset("kernel_forge_pacia_gadget");
    ADDRESS(kernel_forge_pacda_gadget)                      = get_offset("kernel_forge_pacda_gadget");
    ...
    ADDRESS(IOUserClient__vtable)                           = get_offset("IOUserClient__vtable");
    ADDRESS(IORegistryEntry__getRegistryEntryID)            = get_offset("IORegistryEntry__getRegistryEntryID");
}
